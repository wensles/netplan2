...
""",
        ...
        self.assert_networkd_udev(
            {"def1.rules": (UDEV_MAC_RULE % ("?*", "11:22:33:44:55:66", "lom1"))}
        )
        self.assert_nm(None)
...
"""
        ...
        self.assert_nm(None)
        self.assert_nm_udev(
            NM_UNMANAGED_MAC % "11:22:33:44:55:66:77:88:99:00:11:22:33:44:55:66:77:88:99:00"
        )
  ...
  ethernets:
    def1:
      ...
      dhcp4: true"""
        ...
        self.assert_networkd(
            {
                "def1.network": (ND_DHCP4 % "green").replace(
                    "[Network]", "[Link]\nMACAddress=00:01:02:03:04:05\n\n[Network]"
                )
            }
        )
...
"""
        ...
        self.assert_nm(None)
        self.assert_nm_udev(
            'SUBSYSTEM=="net", ACTION=="add|change|move", ENV{ID_NET_NAME}=="en1s*", '
...
"""
        ...
        self.assert_networkd({})
        self.assert_nm_udev(
            'SUBSYSTEM=="net", ACTION=="add|change|move", ENV{ID_NET_NAME}=="engreen", '
...
"""
        ...
        self.assert_nm_udev(
            NM_MANAGED_MAC % "11:22:33:44:55:66:77:88:99:00:11:22:33:44:55:66:77:88:99:00"
        )
