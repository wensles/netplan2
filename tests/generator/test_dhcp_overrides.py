...
"""
        ...
        self.assert_networkd(
            {"engreen.network": ND_DHCP4 % "engreen" + "%s=false\n" % networkd_name}
        )
...
"""
        ...
        self.assert_networkd(
            {"engreen.network": ND_DHCP6 % "engreen" + "%s=false\n" % networkd_name}
        )
...
"""
        ...
        self.assert_networkd(
            {"engreen.network": ND_DHCPYES % "engreen" + "%s=false\n" % networkd_name}
        )
...
"""
        ...
        self.assertEqual(
            err.strip(),
            "ERROR: engreen: networkd requires that "
...
"""
        ...
        self.assert_networkd(
            {"engreen.network": ND_DHCPYES % "engreen" + "%s=foo\n" % networkd_name}
        )
