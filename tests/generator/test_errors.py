...
""",
  ...
  ethernets:
    def1:
      ...
      dhcp4: true""",
        ...
        self.assertIn(
            "Invalid MAC address '00:11:ZZ', must be XX:XX:XX:XX:XX:XX "
  ...
  ethernets:
    engreen:
      ipv6-address-generation: stable-privacy""",
        ...
        self.assertIn(
            "ERROR: engreen: ipv6-address-generation mode is not supported by networkd", err
        )
  ...
  ethernets:
    engreen:
      ...
      ipv6-address-generation: eui64""",
        ...
        self.assertIn(
            "engreen: ipv6-address-generation and ipv6-address-token are mutually exclusive", err
        )
  ...
  nm-devices:
    engreen:
      networkmanager:
        passthrough:
          connection.uuid: "123456"''',
            expect_fail=True,
        )
        self.assertIn(
            "engreen: network type 'nm-devices:' needs to provide a 'connection.type' via passthrough",
            err,
        )
  ...
  ethernets:
    engreen:
      ...
      - 0.0.0.0.0/24:
        ...
        self.assertIn(
            "malformed address '0.0.0.0.0/24', must be X.X.X.X/NN or X:X:X:X:X:X:X:X/NN", err
        )
  ...
  ethernets:
    ...
    enblue:
      ...
      gateway4: 10.49.2.38""",
        ...
        self.assertIn(
            "Conflicting default route declarations for IPv4 (table: main, metric: default)", err
        )
  ...
  ethernets:
    ...
    enblue:
      ...
      gateway6: 2001:FFfe::34""",
            expect_fail=False,
        )
        self.assertIn("Problem encountered while validating default route consistency", err)
        self.assertIn(
            "Conflicting default route declarations for IPv6 (table: main, metric: default)", err
        )
        self.assertIn("engreen", err)
        self.assertIn("enblue", err)
  ...
  ethernets:
    ...
    enred:
      ...
      - to: default
        ...
        self.assertIn("Problem encountered while validating default route consistency", err)
        self.assertIn(
            "Conflicting default route declarations for IPv4 (table: 23, metric: default)", err
        )
        self.assertIn("enblue", err)
  ...
  ethernets:
    ...
    enred:
      ...
      - to: default
        ...
        self.assertIn("Problem encountered while validating default route consistency", err)
        self.assertIn(
            "Conflicting default route declarations for IPv4 (table: main, metric: 600)", err
        )
        self.assertIn("enblue", err)
        self.assertIn("enred", err)
        self.assertNotIn("engreen", err)
  ...
  ethernets: {en1: {}}
  vlans:
    ena: {id: 1, link: en1, renderer: foo}""",
            expect_fail=True,
        )
