    ...
    ethbn:
      ...
      routes:
        ...
        out = subprocess.check_output(
            ["ip", "-6", "route", "show", "dev", self.dev_e_client], text=True
        )
    ...
    ethbn:
      ...
      routes:
        - to: 10.0.0.0/8
          ...
          table: %(tid)s
          on-link: true"""
                % {"r": self.backend, "ec": self.dev_e_client, "tid": table_id}
            )
        self.generate_and_settle([self.dev_e_client])
        self.assert_iface_up(self.dev_e_client, ["inet "])
        out = subprocess.check_output(
            ["ip", "route", "show", "table", table_id, "dev", self.dev_e_client], text=True
        )
        # NM routes have a (default) 'metric' in between 'proto static' and 'onlink'
  ...
  ethernets:
    %(ec)s:
      ...
      routes:
        ...
        self.assertIn(
            b"10.10.10.0/24 via 192.168.5.254",  # from static route
            subprocess.check_output(["ip", "route", "show", "dev", self.dev_e_client]),
        )
        self.assertIn(
            b"metric 99",  # check metric from static route
  ...
  ethernets:
    %(ec)s:
      ...
      routes:
        ...
        self.assertIn(
            b"10.10.10.0/24 via 192.168.5.254",  # from DHCP
            subprocess.check_output(["ip", "route", "show", "dev", self.dev_e_client]),
        )
        self.assertIn(
            b"metric 99",  # check metric from static route
  ...
  ethernets:
    %(ec)s:
      ...
      routes:
        ...
        self.assert_iface_up(self.dev_e_client, ["inet6 9876:bbbb::11/70"])
        self.assertNotIn(
            b"default", subprocess.check_output(["ip", "route", "show", "dev", self.dev_e_client])
        )
        self.assertIn(
            b"via 9876:bbbb::1", subprocess.check_output(["ip", "-6", "route", "show", "default"])
        )
        self.assertIn(
            b"2001:f00f:f00f::/64 via 9876:bbbb::5",
  ...
  ethernets:
    %(ec)s:
      ...
      routes:
        ...
        self.assertIn(
            b"10.10.10.0/24 via 192.168.5.254",
            subprocess.check_output(["ip", "route", "show", "dev", self.dev_e_client]),
        )
        self.assertIn(
            b"metric 99",  # check metric from static route
  ...
  ethernets:
    %(ec)s:
      ...
      routes:
        ...
        self.generate_and_settle([self.dev_e_client])
        self.assertIn(
            b"mtu 777",  # check mtu from static route
            subprocess.check_output(["ip", "route", "show", "10.10.10.0/24"]),
        )
  ...
  ethernets:
    %(ec)s:
      ...
      routes:
        ...
        self.generate_and_settle([self.dev_e_client])
        self.assertIn(
            b"initcwnd 16",  # check initcwnd from static route
            subprocess.check_output(["ip", "route", "show", "10.10.10.0/24"]),
        )
  ...
  ethernets:
    %(ec)s:
      ...
      routes:
        ...
        self.generate_and_settle([self.dev_e_client])
        self.assertIn(
            b"initrwnd 16",  # check initrwnd from static route
            subprocess.check_output(["ip", "route", "show", "10.10.10.0/24"]),
        )
  ...
  ethernets:
    %(ec)s:
      ...
      routes:
        ...
        self.assertIn(
            b"10.10.10.0/24 proto static scope link",
            subprocess.check_output(["ip", "route", "show", "dev", self.dev_e_client]),
        )
        self.assertIn(
            b"metric 99",  # check metric from static route
    ...
    def test_vrf_basic(self):
        ...
        self.addCleanup(
            subprocess.call, ["ip", "link", "delete", "vrf0"], stderr=subprocess.DEVNULL
        )
        self.addCleanup(
            subprocess.call, ["ip", "route", "flush", "table", "1000"], stderr=subprocess.DEVNULL
        )
        self.addCleanup(
            subprocess.call,
            ["ip", "rule", "del", "from", "10.10.10.42", "table", "1000"],
...
"""
        ...
        self.assert_iface_up(
            self.dev_e_client, ["inet 10.10.10.22", "master vrf0"]
        ...
        out = subprocess.check_output(["ip", "route", "show", "table", "1000"], text=True)
      ...
      routes:
        ...
        self.assertIn(
            ...
            subprocess.check_output(
                ["ip", "route", "show", "table", "99", "dev", self.dev_e_client]
            ),
        )
        self.assertIn(
            b"local default",
            subprocess.check_output(
                ["ip", "-6", "route", "show", "table", "100", "dev", self.dev_e_client]
            ),
        )
  ...
  ethernets:
    ethbn:
      ...
      routes:
        ...
        self.assert_iface_up(self.dev_e_client, ["inet "])
        self.assertIn(
            b"10.96.0.0/24 proto static scope link",
            subprocess.check_output(["ip", "route", "show", "dev", self.dev_e_client]),
        )
  ...
  ethernets:
    ethbn:
      ...
      routing-policy:
        ...
        self.generate_and_settle([self.dev_e_client])
        self.assert_iface_up(self.dev_e_client, ["inet "])
        self.assertIn(b"to 40.0.0.0/24 lookup 99", subprocess.check_output(["ip", "rule", "show"]))
        self.assertIn(
            b"40.0.0.0/24 via 10.20.10.88",
